<template>
  <div class="p-10">
    <h3 class="font-titillium font-bold text-4xl mb-10">
      Computravel Website Disclaimer
    </h3>
    <div class="kopa-content">
      <p>
        The information contained in this website is for general information
        purposes only. The information is provided by Computravel cc and whilst
        ...
        in connection with the use of this website.<br />
        <br />
        Through this website you are able to link to other websites which are
        not under the control of Computravel cc. We have no control over the
        ...
        However, Computravel cc takes no responsibility for and will not be
